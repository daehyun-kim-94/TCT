...
public abstract class TctServlet extends HttpServlet {
	...
	protected static final String BODYKEY_PROCESS_TIMEOUT = "ProcessTimeout";
	protected static final String BODYKEY_MAXFAILCOUNT = "MaxFailCount";
	protected static final String BODYKEY_WAITTIME = "WaitTime";
